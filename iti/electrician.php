                ...
                <div class="col-lg-7 offset-lg-1">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="iti-bg">
                            ...
                            <div class="col-lg-3 col-md-3 col-xs-3 iti-icon">
                                <img class="img-responsive" src="img/img/product/1.png">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="iti-bg">
                            ...
                            <div class="col-md-3 col-xs-3 iti-icon">
                                <img class="img-responsive" src="img/img/product/2.png">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="iti-bg">
                            <div class="row">
                            <div class="col-md-3 col-xs-3 iti-icon">
                                <img class="img-responsive" src="img/img/product/3.png">
                            </div>
                            <div class="col-md-9 col-xs-9 iti-text ">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="iti-bg">
                            <div class="row">
                            <div class="col-md-3 col-xs-3 iti-icon">
                                <img class="img-responsive" src="img/img/product/4.png">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="iti-bg">
                            <div class="row">
                            <div class="col-md-3 col-xs-3 iti-icon">
                                <img class="img-responsive" src="img/img/product/5.png">
                            </div>
