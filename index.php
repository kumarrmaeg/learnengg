...
<body>
    ...
    <div class="menu_area menu1">
     ...
     <div class="navbar-nav m-auto " style="display: contents;">
      ...
      <span class="nav-item dropdown">
           <a class="navbar-brand order-sm-1 order-1" target="_blank" href="http://neat.learnengg.com/index.html"><img src="img/img/header/neat.png" alt="learnengg"/></a>
    ...
    <div class="navbar-nav inline-block">
    	 ...
    	 <span class="nav-item dropdown" style="margin-right: 10px;display: inline-grid;">
...
<!-- end -->
    ...
    <div class="intro-three">
        ...
        <div class="intro-three--img">
            <img src="img/img/Header Phone.png" alt="">
    ...
    <div class="row">
        ...
        <div class="offset-lg-3 col-lg-4 col-sm-4 col-xs-12">
            <img src="img/img/For-students/Landing Page Illustrations_Students_A.png">
  ...
  <div class="card card--eleven">
            ...
            <img src="img/img/For-students/For students_icons_Q1.png" alt="fhfghfg" class="rounded-circle">
        ...
        <div class="card-body1 card-body text-center">
            ...
            <div class="card-body text-center">
                 <div style="max-width: 100%">
            <img src="img/img/For-students/For students_icons_Q2.png" alt="fhfghfg" class="rounded-circle">
	...
	<div class="row">       
        <div class="offset-lg-1 col-lg-5 col-sm-4 col-xs-12">
           ...
           <img src="img/img/For professors/Landing Page Illustrations_Professors_A.png">
  ...
  <div class="card card--eleven">
            ...
            <div class="card-body text-center">
                 <div style="max-width: 100%">
            <img src="img/img/For-students/For students_icons_Q3.png" alt="fhfghfg" class="rounded-circle">
    ...
    <div class="container">           
        ...
        <div class="offset-lg-3 col-lg-4 col-sm-4 col-xs-12">
            <img src="img/img/For institutions/Landing Page Illustrations_Institutions_A.png">
...
<section class="padding-top">
 ...
 <div class="row">
                  ...
                  <img src="img/img/engineers-day.jpeg" alt="engineersday">
              ...
              <div class="row">
                  ...
                  <div class=" offset-lg-1 col-lg-5 col-sm-6 col-xs-12 ">
                    <video controls autoplay style="height: 346px;">
                          <source src="vedio1.webm" type="video/webm">
        ...
        <div class="item carousel-item active">
            <div class="row">
                  <div class="col-lg-6">
                    ...
                    <div class="row">
                     <div class="col-lg-3"><img src="img/img/testi1.png">
                     </div>
                     <div class="col-lg-9">
                   ...
                   <div class="col-lg-6">
                     <h5>PROFESSORS</h5>
                   <div class="row">
                     <div class="col-lg-3"><img src="img/img/Professor_R_Kumar.png">
                     </div>
                     <div class="col-lg-9">
                     <p class="testimonial text-left">
